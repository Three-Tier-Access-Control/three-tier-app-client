...
const CreateFingerprintRecordForm = Loadable(lazy(() => import('views/forms/forms-validation/CreateFingerprintRecordForm')));
...
const MainRoutes = {
    ...
    children: [
        ...
        {
            path: '/add-new-fingerprint-record',
            element: <CreateFingerprintRecordForm />
        },
        {
