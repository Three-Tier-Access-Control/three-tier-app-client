...
// =========================|| DASHBOARD ANALYTICS - LATEST VIDEOS TABLE CARD ||========================= //

const LatestVideosCard = ({ title, videosData }) => (
    <MainCard title={title} content={false}>
                ...
                <TableBody>
                    {videosData.map((video, index) => (
                        <TableRow hover key={index}>
                            <TableCell sx={{ pl: 3 }}>
                                <CardMedia component="img" image={video.thumbnail} title="image" sx={{ width: 30, height: 'auto' }} />
                            </TableCell>
        ...
        <CardActions sx={{ justifyContent: 'flex-end' }}>
            <Button component={Link} to="/admin/videos" variant="text" size="small">
                View all Videos
            </Button>
        </CardActions>
    </MainCard>
