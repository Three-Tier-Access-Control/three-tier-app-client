                ...
                <Grid container spacing={2} justifyContent="center">
                    <Grid item>
                        <Typography sx={{ m: 1 }} variant="subtitle1" color="error.main" gutterBottom>
                            Sorry! Failed to retrieve any employees.
                        </Typography>
                    </Grid>
                </Grid>
            )}
                                ...
                                .map((row, index) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <TableCell align="center">{row?.fingerprint ? row?.fingerprint : '-'}</TableCell>
                                            <TableCell align="center">{row?.rfid_card ? row?.rfid_card : '-'}</TableCell>
