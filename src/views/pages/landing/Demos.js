                ...
                <Grid container spacing={2} sx={{ mb: 2 }}>
                    ...
                    <Grid item xs={12}>
                        <Typography variant="body2">
                            Three-Tier Security has customized pages with Material-UI components, Apps, Forms and lots more to explore.
                        </Typography>
                    </Grid>
                </Grid>
            </Grid>
                    ...
                    <Grid item md={4} sm={6}>
                        <FadeInWhenVisible>
                            <ButtonBase component={Link} to="/dashboard/default" target="_blank">
                                <img src={imgDemo1} alt="Three-Tier Security Dashboard" style={imageStyle} />
                            </ButtonBase>
                        </FadeInWhenVisible>
                    </Grid>
                    <Grid item md={4} sm={6}>
                        <FadeInWhenVisible>
                            <ButtonBase component={Link} to="/user/social-profile/posts" target="_blank">
                                <img src={imgDemo2} alt="Three-Tier Security Social App" style={imageStyle} />
                            </ButtonBase>
                        </FadeInWhenVisible>
                    </Grid>
                    <Grid item md={4} sm={6}>
                        <FadeInWhenVisible>
                            <ButtonBase component={Link} to="/app/mail" target="_blank">
                                <img src={imgDemo3} alt="Three-Tier Security Mail App" style={imageStyle} />
                            </ButtonBase>
                        </FadeInWhenVisible>
                    </Grid>
                </Grid>
